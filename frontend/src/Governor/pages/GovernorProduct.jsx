...
import GetAllSites from '../Components/GetAllSites';
import GetProductsIDs from '../Components/GetProductsIDs';
import CreateSite from '../Components/CreateSite';
import ChangePasswordGovernor from '../Components/changePasswordGovernor';
    ...
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      ...
      >
        <div style={{ marginBottom: '10px', borderBottom: '1px solid #ccc' }}>
          <h2 style={{ fontSize: '20px', fontWeight: 'bold' }}>Product Actions</h2>
        </div>
        <nav>
              ...
              <li key={item.id} style={{ marginBottom: '5px' }}>
                <button
                  ...
                  style={{
                    ...
                    padding: '10px',
                    textAlign: 'left',
                    backgroundColor: selectedOption === item.id ? '#007BFF' : 'transparent',
...
export default GovernorProduct;
