...
//               <h2 className="text-4xl font-bold text-white">Site Details</h2>
//             </div>
//             <div className="p-6">
//               <h1 className="text-4xl font-bold text-secondary mb-6">{site.name}</h1>
...
//                 <button
//                   onClick={handleShareLink}
//                   className="bg-primary text-white py-3 px-6 rounded-lg shadow-md hover:bg-primary-dark transition duration-200"
//                 >
//                   Copy Link
//                 </button>
//                 <button
