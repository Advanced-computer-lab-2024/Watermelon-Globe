    ...
    <div className="featured">
      ...
      <div className="bottom">
        <div className="featuredChart">
          <CircularProgressbar
            value={70} // This value can be replaced by a calculation based on your logic
            text={"70%"}
            strokeWidth={5}
            styles={{
              path: {
                stroke: "#6ec2b1", // Red color for the progress path
              },
              text: {
                fill: "	#589ea5", // Red color for the text inside the circle
                fontSize: "16px", // Optional: Adjust the font size
              },
              trail: {
                stroke: "#d6d6d6", // Optional: Gray background for the trail
              },
            }}
          />
        </div>
