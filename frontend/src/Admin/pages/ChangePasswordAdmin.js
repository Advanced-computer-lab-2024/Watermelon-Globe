...
const ChangePasswordAdmin = () => {
  ...
  const handleConfirmPasswordChange = async () => {
    ...
    try {
            const response = await fetch(`/api/Admin/changePasswordAdmin/${sellerId}?oldPassword=${currentPassword}&newPassword=${newPassword}&newPasswordConfirmed=${confirmNewPassword}`, {
    method: 'PUT',
      });
      const data = await response.json();
