...
const SellerPage = () => {
  ...
  return (
    <div style={{ padding: '20px' }}>
      ...
      <button onClick={() => handleRequest(`/updateSeller/${sellerId}`, 'put', rawJson)}>
        Update Seller
      </button>
      <button onClick={() => handleRequest(`/getSeller/${sellerId}`)}>
        Get Seller
      </button>
      <button onClick={() => handleRequest('/sellers')}>
        Get All Sellers
      </button>
      <button onClick={() => handleRequest(`/deleteSeller/${sellerId}`, 'delete')}>
        Delete Seller
      </button>
      ...
      <button onClick={() => handleRequest('/products')}>
        ...
        <button onClick={() => handleRequest(`/searchProductName?name=${productName}`, 'get', rawJson)}>
        ...
        <button onClick={() => handleRequest(`/filterProductPrice/${productPrice}`)}>
      ...
      />
        ...
        <button onClick={() => handleRequest(`/editProduct?id=${prodId}`, 'put', rawJson)}>
          Update Product
        </button>
