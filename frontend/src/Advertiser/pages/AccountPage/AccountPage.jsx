...
const AccountPage = () => {
    ...
    useEffect(() => {
        const fetchProfile = async () => {
            try {
                const response = await axios.get(`/api/Advertiser/profiles/${advertiserId}`);
    ...
    const handleDeleteAccount = async () => {
        ...
        if (confirmed) {
            try {
                const response = await axios.put(`/api/Advertiser/requestDeletionAdvertiser/${advertiserId}`);
