...
export default function DraftHomePage() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <footer className="bg-secondary text-primary p-8">
        <div className="container mx-auto grid grid-cols-1 md:grid-cols-4 gap-8">
          <div>
            <h4 className="font-bold mb-4">About Us</h4>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-hover">Our Story</a></li>
              <li><a href="#" className="hover:text-hover">Team</a></li>
              <li><a href="#" className="hover:text-hover">Careers</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold mb-4">Support</h4>
            <ul className="space-y-2">
              <li><a href="#" className="hover:text-hover">Help Center</a></li>
              <li><a href="#" className="hover:text-hover">Safety Information</a></li>
              <li><a href="#" className="hover:text-hover">Cancellation Options</a></li>
            </ul>
          </div>
          <div>
            <h4 className="font-bold mb-4">Contact Us</h4>
            <ul className="space-y-2">
              <li>support@watermelonglobe.com</li>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a href="#" className="hover:text-hover">Facebook</a>
              <a href="#" className="hover:text-hover">Instagram</a>
              <a href="#" className="hover:text-hover">Twitter</a>
              <a href="#" className="hover:text-hover">LinkedIn</a>
            </div>
          </div>
        </div>
      </footer>
