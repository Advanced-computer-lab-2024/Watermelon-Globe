...
type PaymentOptionsProps = {
  ...
  disableCashOnDelivery?: boolean;  // New prop to disable cash on delivery
};

export default function PaymentOptions({
  paymentMethod,
  onPaymentMethodSelection,
  disableCashOnDelivery = false,  // Default to false if not passed
}: PaymentOptionsProps) {
  return (
    <div className="payment-options-container bg-sectionBackground p-6 rounded-lg shadow-md">
      ...
      <div className="payment-options grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        {/* Conditionally render Cash on Delivery option */}
