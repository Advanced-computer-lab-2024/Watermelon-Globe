...
import { FaWallet } from 'react-icons/fa'; // Import FaWallet from react-icons

const WalletComponent = () => {
    const { touristId } = useParams(); // Extract touristId from the URL
    ...
    return (
        <div>
            ...
            <div
                ...
                title="View Wallet"
            >
                <FaWallet className="text-2xl" /> {/* FaWallet icon from react-icons */}
            </div>
            ...
            {isWalletOpen && (
                ...
                >
                    ...
                    >
                        {/* Display Wallet Icon Instead of Title */}
