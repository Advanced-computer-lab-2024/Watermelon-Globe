import "./dataTableAdvertiser.scss";
...
const DatatableAdvertiser = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "/api/Advertiser/frontendAdvertiserTable"
        );
  ...
  const handleDelete = (id) => {
    ...
    axios
      .delete(`/api/Advertiser/deleteProfile/${id}`)
...
export default DatatableAdvertiser;
