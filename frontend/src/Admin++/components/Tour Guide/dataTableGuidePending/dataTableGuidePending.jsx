import "./dataTableGuidePending.scss";
...
const DatatableGuidePending = () => {
    ...
    const fetchData = async () => {
      try {
        const response = await axios.get(
          "/api/TourGuide/frontendPendingGuidesTable"
        );
  ...
  const handleReject = (id) => {
    ...
    axios
      .put(`/api/Admin/rejectTourGuide/${id}`)
  ...
  const handleAccept = (id) => {
    ...
    axios
      .put(`/api/Admin/acceptTourGuide/${id}`)
      .catch((err) => console.error(err));
  };
...
export default DatatableGuidePending;
