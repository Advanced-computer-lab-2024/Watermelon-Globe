...
const CreateProduct = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(`/api/Admin/CreateProduct/${id}`, {
        method: "POST",
      ...
      if (!response.ok) {
        ...
        setErrorMessage(
          errorData.error || "Failed to create product. Please try again."
        );
      } else {
            ...
            <form onSubmit={handleSubmit}>
              ...
              <div className="flex justify-center">
                <button
                  ...
                  className="bg-green-700 text-white px-4 py-2  rounded mt-6"
                  type="submit"
                >
                  Create Product
                </button>
