...
const getTags = async (req, res) => {
    ...
    const createActivity = async (req, res) => {
        try {
            const { Name, Date, Time, Location, Price, priceRange, Category, tags, Discount, bookingOpen,
                Rating, Advertiser} = req.body; // Expect userId in the request body
            ...
            const newActivity = await ActivityModel.create({
                Name, Date, Time, Location, Price, priceRange, Category, tags, Discount, bookingOpen,
                Rating, Advertiser });
